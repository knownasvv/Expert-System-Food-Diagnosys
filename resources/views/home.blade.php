...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container mx-auto d-flex align-items-center my-5 p-0">
        <div class="row w-100 align-middle row-cols-2 m-0 d-flex justify-content-evenly">
            <div class="card col-md-3 col-lg-3 col-xs-12 col-sm-12 p-0">
                    ...
                    <div class="accordion-item p-0">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button"
                                style="font-family: 'Inconsolata', monospace; font-weight: bold; border: 0px; background: #cefdce; color: black;"
                                type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                aria-expanded="true" aria-controls="collapseOne">
                                ABOUT FOODN'T
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse p-0" aria-labelledby="headingOne"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body p-0">
                                <div class="card-body p-0 py-2" style="font-size: 0.8rem;">
                                    <p class="text-center px-1 py-2 m-0">A food diagnosys expert system using <i>forward
                                            chaining.</i></p>
                ...
                @elseif((isset($start) && $start == "yes" )|| (isset($systemEnd)))
            ...
            <div class="card col-md-8 col-lg-8 col-xs-12 col-sm-12 p-0">
                ...
                <form class="text-center card-body" action="{{ url("/first-yes") }}" method="post">
                    ...
                    <div class="container row" style="background: none;">
                        <div class="col-6">
                            ...
                            <button type="submit" name="action" value="product" class="btn btn-primary"
                                style="background-color: rgb(245, 213, 154); color: black;">Product</button>
                        </div>
                        <div class="col-6">
                            <img class="img col-12 mb-3" src="{{ asset('images/organic.jpg') }}" />
                            <button type="submit" name="action" value="organic" class="btn btn-primary"
                                style="background-color: rgb(172, 245, 154); color: black;">Organic</button>
                        </div>
                    </div>
                </form>
                ...
                <form class="text-center form-group card-body mx-3" action="{{ url("/first-no") }}" method="post">
                    {{ csrf_field() }}
                ...
                <form class="form-control card-body" action="{{ url("/second-product") }}" method="post"
                    ...
                    <div class="row pl-5 container-fluid" style="background: none;">
                        ...
                        <div class="pretty p-default p-round p-smooth p-plain mb-2 col-5">
                            <input type="checkbox" name="substances[]" value="{{ $subs->{"kode zat"} }}"
                                id="{{ $subs->{"kode zat"} }}" />
                ...
                <form class="card-body" action="{{ url("/second-product-check") }}" method="post">
                    {{ csrf_field() }}
                    <h5>The system determined that, the food you ate excessively is better avoided if you have disease
                        in:</h5>
                                ...
                                <ul style="list-style-type:none; list-style-position: inside; padding-left: 0;">
                                    ...
                                    <li class="my-2 col-lg-6 col-sm-12">
                                        <div class="pretty p-default p-round p-smooth p-plain">
                                            <input type="checkbox" class="list_diseases" name="diseases[]"
                                                value="{{ $d->{'nama penyakit'} }}" />
                                            <div class="state p-success-o">
                    ...
                    <div class="container buttons">
                        <button type="submit" id="submit-to-second-product-check" name="action" value="yes"
                ...
                <form class="text-center card-body" action="{{ url("/ending") }}" method="post">
                    {{ csrf_field() }}
                    <h5>The system determined that, the food you ate excessively is safe no matter what disease you
                        have.</h5>
                ...
                <form class="text-center card-body" action="{{ url("/ending") }}" method="post">
                    {{ csrf_field() }}
                    <h5>Sorry the system is not capable to find any answers ☹️</h5>
                    <h5>Do you want to start from the beginning?</h5>
                    <div class="container buttons">
                        <button type="submit" name="action" value="yes" class="btn btn-primary">Yes</button>
                        <button type="submit" name="action" value="no" class="btn btn-primary">No</button>
    ...
    <footer class="footer mt-auto py-3" style="background:#5CB85C; color: white;">
        <div class="container">
            <a href="https://github.com/knownasvv/Expert-System-Food-Diagnosys" target="_blank"
                style="text-decoration: none; color: white;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github"
                    style="line-height: 1rem;" viewBox="0 0 16 16">
                    <path
